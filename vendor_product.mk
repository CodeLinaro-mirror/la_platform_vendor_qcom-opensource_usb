...
ifneq ($(filter lahaina taro blair kalama pineapple sun parrot canoe,$(TARGET_BOARD_PLATFORM)),)
...
ifeq ($(USB_USES_QMAA),true)
  ...
  #
  ifneq ($(filter taro kalama pineapple sun canoe,$(TARGET_BOARD_PLATFORM)),)
