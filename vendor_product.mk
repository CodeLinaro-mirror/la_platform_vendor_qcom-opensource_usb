...
ifneq ($(filter blair bengal,$(TARGET_BOARD_PLATFORM)),)
...
ifneq ($(filter lahaina taro blair kalama pineapple sun parrot canoe vienna bengal,$(TARGET_BOARD_PLATFORM)),)
...
ifeq ($(USB_USES_QMAA),true)
  ...
  #
  ifneq ($(filter taro kalama pineapple sun canoe vienna lahaina bengal,$(TARGET_BOARD_PLATFORM)),)
