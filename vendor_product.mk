...
#
ifneq ($(filter seraph niobe,$(TARGET_BOARD_PLATFORM)),)
...
ifeq ($(USB_USES_QMAA),true)
  ...
  #
  ifneq ($(filter seraph niobe taro kalama pineapple blair monaco pitti volcano anorak61 neo61,$(TARGET_BOARD_PLATFORM)),)
